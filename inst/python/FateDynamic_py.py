...
if palantir_model:
    ...
    if plot:
        scv.pl.velocity_embedding_stream(adata, basis='X_umap',color=cluster_label,figsize=[6,4],dpi=300,save="velocity_embedding_stream.png",legend_loc='right margin')
